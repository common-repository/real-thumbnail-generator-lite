...
use WP_Error;
use DevOwl\RealThumbnailGenerator\Vendor\YahnisElsts\PluginUpdateChecker\v5\PucFactory;
use DevOwl\RealThumbnailGenerator\Vendor\YahnisElsts\PluginUpdateChecker\v5p3\UpdateChecker;
