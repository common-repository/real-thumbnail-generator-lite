...
if (!\function_exists('DevOwl\\RealThumbnailGenerator\\Vendor\\json5_decode')) {
    /**
    ...
    {
        return \DevOwl\RealThumbnailGenerator\Vendor\ColinODell\Json5\Json5Decoder::decode($source, $associative, $depth, $options);
    }
}
// PHP 7.3 polyfills
