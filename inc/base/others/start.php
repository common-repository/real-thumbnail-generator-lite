...
use DevOwl\RealThumbnailGenerator\Vendor\DevOwl\Freemium\Autoloader;
use DevOwl\RealThumbnailGenerator\Core;
\defined('ABSPATH') or die('No script kiddies please!');
// Avoid direct file request
// Check minimum WordPress version
global $wp_version;
if (\version_compare($wp_version, \RTG_MIN_WP, '>=')) {
    $load_core = \false;
    ...
    if ($load_core) {
        ...
        $composer_autoload_path = \RTG_PATH . '/vendor/autoload.php';
        $composer_scoper_autoload_path = \RTG_PATH . '/vendor/scoper-autoload.php';
        ...
        require_once \RTG_INC . 'base/others/fallback-rest-api.php';
    }
} else {
    // Min WP version not reached
    require_once \RTG_INC . 'base/others/fallback-wp-version.php';
}
